package com.finance.eclipse.suggestion.history;
...
public class AiHistoryEntry {
	...
	// cons
	public AiHistoryEntry(String file, String previousContent) {
	...
	public String toString() {
		return "AiHistoryEntry [timestamp=" + timestamp + ", file=" + file + ", modelLabel="
