...
public final class AiCodeCleanupUtils {

	private AiCodeCleanupUtils() {
	...
	public static void triggerSaveActions(ICompilationUnit compilationUnit) throws OperationCanceledException, CoreException {
		...
		if (activeEditor instanceof ITextEditor) {
			...
			try {
				...
				AiActivator.getDefault().getLog().log(new Status(IStatus.ERROR, AiActivator.PLUGIN_ID, "Failed to add cursor position", exception));
			}
		}
